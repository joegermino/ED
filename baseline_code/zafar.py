import numpy as np
import baseline_code.zafar_loss_funcs as lf
import baseline_code.zafar_utils as ut
import baseline_code.zafar_funcs_disp_mist as fdm
...
def fairness_constraints_paper(train_X, train_y, test_X, pcs):
